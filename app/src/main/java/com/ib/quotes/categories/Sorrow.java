...
public class Sorrow extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@NonNull Bundle savedInstanceStart) {
        ...
        getSupportActionBar().setTitle("দুঃখ");
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Sorrow");
        myQuote = new Model();
