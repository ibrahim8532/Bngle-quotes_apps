...
public class Troble extends AppCompatActivity implements View.OnClickListener{
...
protected void onCreate(@NonNull Bundle savedInstanceStart) {
        ...
        getSupportActionBar().setTitle("কষ্ট");
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Troble");
        myQuote = new Model();
