...
public class Feeling extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@NonNull Bundle savedInstanceStart) {
        ...
        getSupportActionBar().setTitle("অনুভুতি");
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Feeling");
        myQuote = new Model();
