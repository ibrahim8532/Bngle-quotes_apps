...
public class Mind extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@NonNull Bundle savedInstanceStart) {
        ...
        getSupportActionBar().setTitle("মন");
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Mind");
        myQuote = new Model();
