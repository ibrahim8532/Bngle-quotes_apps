...
public class Woman extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@NonNull Bundle savedInstanceStart) {
        ...
        getSupportActionBar().setTitle("নারী");
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Woman");
        myQuote = new Model();
