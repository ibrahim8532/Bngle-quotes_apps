...
public class Valobasa extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@NonNull Bundle savedInstanceStart) {
        ...
        getSupportActionBar().setTitle("ভালোবাসা");
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Valobase");
        myQuote = new Model();
